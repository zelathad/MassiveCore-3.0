...
public class TypeSound extends TypeAbstractChoice<Sound>
{
	// -------------------------------------------- //
	// DATA
	// -------------------------------------------- //
	...
	{
		super(Sound.class);
		List<Sound> all = new ArrayList<>();
		Registry.SOUNDS.forEach(all::add);
		this.setAll(all);
		this.setHelp(
	...
	public Set<String> getIdsInner(Sound value)
	{
		...
		// Fill
		String current = value.getKey().getKey();
		ret.add(current);
		ret.add(value.getKey().toString());
